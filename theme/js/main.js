  ...
  var require_flying_pages = __commonJS({
    "node_modules/flying-pages-module/flying-pages.js"(exports, module) {
      module.exports = (options = {}) => {
        const toPrefetch = /* @__PURE__ */ new Set();
        const alreadyPrefetched = /* @__PURE__ */ new Set();
        ...
        const prefetchWithTimeout = (url) => {
          const timer = setTimeout(() => stopPrefetching(), 5e3);
        ...
        const startQueue = () => setInterval(() => {
          Array.from(toPrefetch).slice(0, window.FPConfig.maxRPS).forEach((url) => {
            prefetchWithTimeout(url);
            alreadyPrefetched.add(url);
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  var DOM_default = () => {
    return {
      ...
      init() {
        (0, import_debugLog.default)("AlpineJS DOM init");
      }
    };
  };
